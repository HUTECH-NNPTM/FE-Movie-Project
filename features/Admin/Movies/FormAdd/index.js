...
function AddMovie({ handleCloseForm }) {
  ...
  return (
    <div className="fixed max-h-[500px] rounded-md bg-gray-100 shadow center-item top-[52%] border-[1px] border-gray-900 overflow-y-auto h-[500px] w-[750px] z-10 scrollbar-thin scrollbar scrollbar-thumb-gray-900 scrollbar-track-gray-100 ">
      {/* CLOSE BUTTON */}
      <form className="relative p-8" onSubmit={handleSubmit}>
        <div
