...
import { removeSeries } from "../../../../slice/seriesSlice";
import PlayerAdmin from "../../Player";

function SeriesItem({ item, handleFormEdit}) {
  ...
  return (
    <tr>
      ...
      <td className="p-2 whitespace-nowrap">
        <div className="text-left font-medium text-green-500">{item.type}</div>
      </td>
       <td className="p-2 whitespace-nowrap">
        <div className="text-left font-medium text-green-500">{item.limit}</div>
      </td>
       <td className="p-2 whitespace-nowrap">
      ...
      <td className="p-2 whitespace-nowrap">
        <div className="text-center">
          {/* Edit */}
          <button
            onClick={() => handleFormEdit(item._id)}
            title="edit"
